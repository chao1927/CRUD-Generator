...
public abstract class IntrospectedTable {
    ...
    protected void calculateControllerAttributes(){
        String pkg=calculateJavaControllerPackage();
        setControllerType(pkg+"."+fullyQualifiedTable.getDomainObjectName()+"Controller");
    }

    protected void calculateServiceAttributes() {
        String pkg=calculateJavaServicePackage();
        setServiceType(pkg+"."+fullyQualifiedTable.getDomainObjectName()+"Service");
        String implPkg=pkg+".impl";
        setServiceImplType(implPkg+"."+fullyQualifiedTable.getDomainObjectName()+"ServiceImpl");
    }
    ...
    public void setControllerType(String controllerType){
        internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_TYPE,controllerType);
    }
