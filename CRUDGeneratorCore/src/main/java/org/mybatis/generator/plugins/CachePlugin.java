...
/**
 * This plugin adds a cache elements to generated sqlMaps.  This plugin
 ...
 * cache_type
 * 
 * All properties correspond to properties of the MyBatis cache elements and
 * are passed "as is" to the corresponding properties of the generated cache
 * elements.  All properties can be specified at the table level, or on the
 * plugin elements.  The property on the table elements will override any
 * property on the plugin elements.
 * 
