...
public interface Rules {
    ...
    /**
     * Implements the rule for generating the insert SQL Map elements and DAO
     * method. If the insert statement is allowed, then generate the elements and
     * method.
     * 
     * @return true if the elements and method should be generated
     */
    boolean generateInsert();

    /**
     * Implements the rule for generating the insert selective SQL Map elements
     ...
     * BLOBs SQL Map elements and DAO method. If the table has a primary key as
     * well as other non-BLOB fields, and the updateByPrimaryKey statement is
     * allowed, then generate the elements and method.
     * 
     * @return true if the elements and method should be generated
     */
     ...
     * SQL Map elements and DAO method. If the table has a primary key as well as
     * other BLOB fields, and the updateByPrimaryKey statement is allowed, then
     * generate the elements and method.
     * 
     * @return true if the elements and method should be generated
     */
     ...
     * elements and DAO method. If the table has a primary key, and the
     * deleteByPrimaryKey statement is allowed, then generate the elements and
     * method.
     * 
     * @return true if the elements and method should be generated
     */
    ...
    /**
     * Implements the rule for generating the delete by example SQL Map elements
    ...
    /**
     * Implements the rule for generating the SQL example where clause elements.
     * 
     * In iBATIS2, generate the elements if the selectByExample, deleteByExample,
     * updateByExample, or countByExample statements are allowed.
     * 
     * In MyBatis3, generate the elements if the selectByExample,
     * deleteByExample, or countByExample statements are allowed.
     * 
     * @return true if the SQL where clause elements should be generated
     */
     ...
     * 
     * In iBATIS2, do not generate the elements.
     * 
     * In MyBatis, generate the elements if the updateByExample statements are
     * allowed.
     * 
     * @return true if the SQL where clause elements should be generated
     */
    ...
    /**
     * Implements the rule for generating the SQL base column list elements.
     * Generate the elements if any of the select methods are enabled.
     * 
     * @return true if the SQL base column list elements should be generated
     */
    boolean generateBaseColumnList();

    /**
     * Implements the rule for generating the SQL blob column list elements.
     * Generate the elements if any of the select methods are enabled, and the
     * table contains BLOB columns.
     * 
     * @return true if the SQL blob column list elements should be generated
     */
    boolean generateBlobColumnList();

    /**
     * Implements the rule for generating the select by primary key SQL Map
     * elements and DAO method. If the table has a primary key as well as other
     ...
     * SQL Map elements and DAO method. If the selectByExample statement is
     * allowed, then generate the elements and method.
     * 
     * @return true if the elements and method should be generated
     */
     ...
     * Map elements and DAO method. If the table has BLOB fields and the
     * selectByExample statement is allowed, then generate the elements and
     * method.
     * 
     * @return true if the elements and method should be generated
     */
