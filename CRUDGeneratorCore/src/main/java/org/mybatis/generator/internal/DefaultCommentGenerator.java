...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    /**
     * Adds a suitable comment to warn users that the elements was generated, and
    ...
    public void addComment(XmlElement xmlElement) {
        ...
        xmlElement
                .addElement(new TextElement(
                        "  This elements is automatically generated by MyBatis Generator, do not modify.")); //$NON-NLS-1$

        String s = getDateString();
        if (s != null) {
            sb.setLength(0);
            sb.append("  This elements was generated on "); //$NON-NLS-1$
            sb.append(s);
            sb.append('.');
            xmlElement.addElement(new TextElement(sb.toString()));
        }
