...
public class AddMethodImplGenerator extends AbstractServiceImplMethodGenerator {
    ...
    public void addInterfaceElements(TopLevelClass clazz) {
         ...
         *  dao.insert..();
         */
        method.addBodyLine(StringUtility.convertFieldName(mapperType.getShortName())+".insert("+paramName+");");
